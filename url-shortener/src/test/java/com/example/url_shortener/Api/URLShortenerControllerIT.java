...
class URLShortenerControllerIT {
    ...
    @Test
    @DisplayName("POST /api/urls: create short URL end-to-end")
    ...
    @Test
    @DisplayName("POST /api/urls -> Create: create short return 400 BadRequest (bad url)")
    void create_shouldReturn404_BadRequest_BadUrlFormatting() throws Exception {
        UrlCreateRequest request =
                new UrlCreateRequest("example");
    ...
    @Test
    @DisplayName("GET /r/{code} -> Redirect: redirect increments hit count")
    ...
    @Test
    @DisplayName("GET /r/{code} -> Redirect: return 404 when code doesn't exist")
    void redirect_should_404_code_not_exist() throws Exception {
    ...
    @Test
    @DisplayName("GET /api/urls/{code} -> Metadata: metadata reflects hit count")
    ...
    @Test
    @DisplayName("GET /api/urls/{code} -> Metadata: return 404 when code doesn't exist")
    void metadata_should_404_code_not_exist() throws Exception {
